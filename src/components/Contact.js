...
import animation from "../assets/Animation - 1702407915242.json";
  ...
  return (
    <div className=" section" id="contact">
      ...
      <div className=" container mx-auto md:flex gap-3 justify-between">
        <div className=" md:max-w-[50%]">
          ...
          <motion.p
            ...
            viewport={{ once: false, amount: 0.7 }}
          >
            Here I provide a form please fill this form with valid information
            then I will surely response as soon as possible
          </motion.p>
        ...
        <div>
          <motion.form
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.7 }}
            class="max-w-screen-lg mt-28 mb-2 w-80 sm:w-96 "
          >
            <div class="flex flex-col gap-6 mb-1">
              ...
              <div class="relative  w-full min-w-[200px]">
                <textarea className=" bg-transparent border-2 border-white text-white font-bold px-3" rows="4" cols="50"
                  name="message"
      ...
      type="button" value="Submit">
            ...
            <input type="submit" value="Send" className=" btn btn-sm my-3" />
          </motion.form>
        </div>
      </div>
    </div>
