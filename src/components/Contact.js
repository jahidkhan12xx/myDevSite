      ...
      <div className=' container mx-auto flex gap-3 justify-between'>
        ...
        <motion.h2
            ...
            <motion.p className=" mt-12 "
              ...
              viewport={{ once: false, amount: 0.7 }}
            >
             Here I provide a form please fill this form with valid information then I will surely response as soon as possible
            </motion.p>
        </div>
        <div>
        <motion.form
        ...
        initial="hidden"
        whileInView={"show"}
        viewport={{ once: false, amount: 0.7 }} class="max-w-screen-lg mt-20 mb-2 w-80 sm:w-96 ">
